...
namespace JescoDev.SmoothBrainStates.Editor {
    public class BoundPort : Port {
        ...
        public readonly SerializedPropertySmoothPort PortProperty;
        ...
        private BoundPort(MovementEditorNode movementEditorNode, string portName, bool showName, Direction direction)
            ...
            PortProperty = new SerializedPropertySmoothPort(movementEditorNode.State.FindPropertyRelative(portName));

            this.portName = !showName ? "" : ObjectNames.NicifyVariableName(portName);
        }
