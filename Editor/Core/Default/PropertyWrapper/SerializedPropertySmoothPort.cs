...
namespace JescoDev.SmoothBrainStates.Editor {
    public class SerializedPropertySmoothPort : SerializedPropertyExtension {

        public string Identifier => Property.name;
        public readonly SerializedProperty TransitionsProperty;

        public SerializedPropertySmoothPort(SerializedProperty property) : base(property) {
        ...
        public override bool IsValid() {
            return Property != null && TransitionsProperty != null;
        }
    }
    ...
    public class SerializedPropertyTransition : SerializedPropertyExtension {
        ...
        public override bool IsValid() {
            return Property != null && _stateGuidProperty != null && _portIdentifierProperty != null;
        }
    }
}